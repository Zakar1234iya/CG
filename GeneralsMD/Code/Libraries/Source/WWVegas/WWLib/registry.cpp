        ...
        while (result == ERROR_SUCCESS) {
                ...
                if (result == ERROR_SUCCESS) {
                        switch (type) {
                                ...
                                */
                                case REG_DWORD:
                                        snprintf(save_name, sizeof(save_name), "DWORD_%s", value_name);
                                ...
                                */
                                case REG_SZ:
                                        snprintf(save_name, sizeof(save_name), "STRING_%s", value_name);
                                ...
                                */
                                case REG_BINARY:
                                        snprintf(save_name, sizeof(save_name), "BIN_%s", value_name);
                ...
                while (result == ERROR_SUCCESS) {
                        ...
                        if (result == ERROR_SUCCESS) {
                                ...
                                */
                                ...
                                snprintf(new_key_path, sizeof(new_key_path), "%s\\%s", path, name);
