...
bool DX8Wrapper::Create_Device(void)
{
        ...
        (
                ...
                ( 
                        ...
                        (
                                CurRenderDevice,
                                0,  // Fixed: D3DENUM_NO_WHQL_LEVEL is a DX9 flag, invalid for DX8 ABI — causes D3DERR_INVALIDCALL on modern drivers
...
void DX8Wrapper::Enumerate_Devices()
{
        ...
        for (int adapter_index=0; adapter_index<adapter_count; adapter_index++) {
                ...
                HRESULT res = D3DInterface->GetAdapterIdentifier(adapter_index, 0, &id);  // Fixed: D3DENUM_NO_WHQL_LEVEL is DX9-only
                ...
                if (res == D3D_OK) {
                        ...
                        */
                        ...
                        D3DInterface->GetAdapterIdentifier(adapter_index, 0, &desc.AdapterIdentifier);  // Fixed: D3DENUM_NO_WHQL_LEVEL is DX9-only
