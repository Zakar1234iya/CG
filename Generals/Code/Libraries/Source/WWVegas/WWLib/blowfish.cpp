...
BlowfishEngine::~BlowfishEngine(void)
{
        ...
        memset(P_Encrypt, 0, sizeof(P_Encrypt));
        memset(P_Decrypt, 0, sizeof(P_Decrypt));
        memset(bf_S, 0, sizeof(bf_S));
}
...
int BlowfishEngine::Encrypt(void const * plaintext, int length, void * cyphertext)
{
        ...
        /*
        **      Cannot encrypt without a key - return error.
        */
        return(0);
}
...
int BlowfishEngine::Decrypt(void const * cyphertext, int length, void * plaintext)
{
        ...
        /*
        **      Cannot decrypt without a key - return error.
        */
        return(0);
}
